...
if(isset($_POST['lunch_suggestions_delete'])){
  $hash = array();
  $hash['lunch_suggestion_display'] = 0;
  if($lunch_suggestions_obj->update_lunch_suggestions(array('hash' => $hash))){
    header("Location: /lunch");
  }
}
...
include($_SERVER['DOCUMENT_ROOT'].$T['webroot'].'/templates/delete/lunch-suggestions.tpl.php');
?>
